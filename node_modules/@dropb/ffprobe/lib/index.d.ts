 ...
 */
declare function ffprobe(input: string | Stream$1): Promise<FfprobeData>;
declare function ffprobe(input: string | Stream$1, cb: FfprobeCallback): void;
 ...
 */
declare const ffprobeSync: typeof ffprobeSyncDeprecated;

export { FfprobeCallback, FfprobeData, FfprobeError, FfprobeOpts, ffprobe, ffprobeSync };
